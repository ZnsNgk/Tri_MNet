...
class SwinTransformer(nn.Module):
    ...
    def __init__(
            self, img_size=64, patch_size=4, in_chans=1, num_classes=5, global_pool='avg',
...
def swin_tiny(pretrained=False, **kwargs):
    ...
    """
    model = SwinTransformer(patch_size=4, window_size=8, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), **kwargs)

    return model

if __name__ == "__main__":
    model = swin_tiny(False, img_size=64, in_chans=1)
    print(model)
